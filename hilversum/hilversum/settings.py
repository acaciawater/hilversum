"""
Django settings for hilversum project.
...
WSGI_APPLICATION = 'hilversum.wsgi.application'
...
# Grapelli admin
GRAPPELLI_ADMIN_TITLE='Beheer van grondwatermeetnet Gemeente Hilversum'
